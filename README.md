...
|   |  |__index.html
|   |
|   |__index.redirects   # For Cloudflare Worker Deployment
|          
├── themes/
...
2. Create a corresponding layout in **`themes/tailbliss/layouts/`** if needed and if a redirect is needed duplicate it up front in the root layouts folder. Remove the redirect in both places to start landing in the root again.
...
MIT License - feel free to use and modify for your needs, it's all I'm doing.
